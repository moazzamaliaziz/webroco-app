...
function WorkCard({ w, index }: { w: typeof WORK[number]; index: number }) {
  return (
    ...
    >
      ...
      <div className="mt-1 text-sm text-foreground/55">{w.year} â€“ {w.cat}</div>
    </motion.a>
  );
}
...
const TESTIMONIALS = [
  { quote: "Webroco transformed our online presence. Strategy, craft and care from kick-off to launch â€” the results speak for themselves.", name: "Jonathan Reed", role: "CEO, Northwind" },
  ...
  { quote: "Senior-level partners â€” not vendors. They challenged our assumptions, then delivered beyond the brief.", name: "Marcus Hollis", role: "Founder, Northshore" },
  ...
  { quote: "They don't just build websites â€” they craft experiences. Our conversion rate doubled within 3 months.", name: "David Park", role: "Founder, Nexus" },
];
